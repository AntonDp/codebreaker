...
module Codebreaker
  RSpec.describe Game do
    ...
    context "#analyze guess" do
      ...
      code = ['1134','2234','1243','1234','1234','1134','1134','1134','1234','1234','1234','1234','1234','1212']
      guess = ['1165','2215','2777','2845','5124','5115','5511','5111','1555','5224','5154','5234','5134','1211']
      result = ['++','++','-','--','+--','+-', '--','+-', '+','++', '+-', '+++', '++-','+++']
      
      code.each_with_index do |code, i|
        it "secret_code - #{code} and guess - #{guess[i]} return #{result[i]}" do
          game.send(:secret_code=, code)
          expect(game.send(:analyze_guess, guess[i])).to eq(result[i])
        end
      end 
    end
    ...
    context "#hint" do
      ...
      it "return hint with one random secret code" do
